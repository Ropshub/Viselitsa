let slova = ["кошка","живот","икота","левый","успех","молоко","археолог","цифра","шаиба","шкура","щенок","ангел","буква","актив","арена"];
let slovo = slova[Math.floor(Math.random()*slova.length)];
let p = 12;
let bukvi = []
document.querySelector(".start").onclick = function(){
	for (let i = 0;i<slovo.length;i++) {
		slova = ["кошка","живот","икота","левый","успех","молоко","археолог","цифра","шаиба","шкура","щенок","ангел","буква","актив","арена"];
		...
		document.querySelector(".bukva").disabled = false;
	}
}
function clickPress(event){
	...
	for (let i = 0;i<slovo.length;i++) {
		...
		if (p==0) {
		document.querySelector(".bukva").disabled = true;
		}
		if (p==11) {
		...
		if (p==5) 		document.getElementsByClassName('men')[0].style.backgroundImage = "url('img/5.png')";
		}
		if (p==4) {
		...
		document.querySelector(".bukva").value = ""
		document.querySelector(".bukva").focus()
